<script>
  ...
  import { dateTimeFormat, longFormatDate } from "../global.js"

  // __ COMPONENTS
  import Blocks from "../blocks/blocks.svelte"
  import SeeAlso from "$../see-also/see-also.svelte"
  import PersonLink from "../person-link/person-link.svelte"

  // __ GRAPHICS
  import ExternalLink from "../graphics/external-link.svelte"
