...
function writable(value, start = import_index_18e7c772.n) {
  let stop;
  const subscribers = /* @__PURE__ */ new Set();
  function set(new_value) {
    if ((0, import_index_18e7c772.d)(value, new_value)) {
      value = new_value;
      if (stop) {
  ...
  function subscribe(run, invalidate = import_index_18e7c772.n) {
    const subscriber = [run, invalidate];
    subscribers.add(subscriber);
    if (subscribers.size === 1) {
      stop = start(set) || import_index_18e7c772.n;
    }
    run(value);
    return () => {
...
const External_link = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
...
const Text = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  const renderNewLines = (t) => t.replace(/(?:\r\n|\r|\n)/g, "<br>");
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  return `${b.children && b.children.length > 0 ? `${b.style == "h2" ? `<h2${(0, import_index_18e7c772.f)("id", (0, import_slugify.default)(b.children[0].text, { lower: true }), 0)}>${(0, import_index_18e7c772.b)(b.children, (c) => {
    return `${!c.marks || c.marks.length === 0 ? `${(0, import_index_18e7c772.e)(c.text)}` : `<strong>${(0, import_index_18e7c772.e)(c.text)}</strong>`}`;
  })}</h2>` : `${b.style == "h3" ? `<h3>${(0, import_index_18e7c772.b)(b.children, (c) => {
    return `${(0, import_index_18e7c772.e)(c.text)}`;
  })}</h3>` : `<p>${(0, import_index_18e7c772.b)(b.children, (c) => {
    return `${!c.marks || c.marks.length === 0 ? `<!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END -->` : `${c.marks.includes("em") ? `<em><!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END --></em>` : `${c.marks.includes("strong") ? `<strong><!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END --></strong>` : `${b.markDefs.find((m) => m._key === c.marks[0])._type === "link" ? `<a${(0, import_index_18e7c772.f)("href", b.markDefs.find((m) => m._key === c.marks[0]).href, 0)}><!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END --> ${(0, import_index_18e7c772.v)(External_link, "ExternalLink").$$render($$result, {}, {}, {})}</a>` : ``}
          ${b.markDefs.find((m) => m._key === c.marks[0])._type === "person" ? `${(0, import_index_18e7c772.v)(Person_link, "PersonLink").$$render($$result, {
      overrideText: c.text,
...
const Image = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  ...
  ].join(" ").trim()}"><img${(0, import_index_18e7c772.f)("src", urlFor(b.asset).quality(90).saturation(-100).width(1e3).url(), 0)}${(0, import_index_18e7c772.f)("alt", b.alt ? b.alt : "", 0)} class="${"svelte-1bbn2f1"}">
  ${(0, import_has.default)(b, "caption.content") ? `<figcaption class="${"svelte-1bbn2f1"}">${(0, import_index_18e7c772.v)(Blocks, "Blocks").$$render($$result, { blocks: b.caption.content }, {}, {})}</figcaption>` : ``}
</figure>`;
});
...
const ImageFromMainSite = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  ...
  return `<figure class="${[
    "svelte-1bbn2f1",
    (b.layout == "left" ? "left" : "") + " " + (b.layout == "right" ? "right" : "") + " " + (b.fullWidth ? "full" : "") + " " + (b.coverAndCrop ? "cover" : "")
  ].join(" ").trim()}"><img${(0, import_index_18e7c772.f)("src", urlForMainSite(b.asset).quality(90).saturation(-100).width(1e3).url(), 0)}${(0, import_index_18e7c772.f)("alt", b.alt ? b.alt : "", 0)} class="${"svelte-1bbn2f1"}">
  ${(0, import_has.default)(b, "caption.content") ? `<figcaption class="${"svelte-1bbn2f1"}">${(0, import_index_18e7c772.v)(Blocks, "Blocks").$$render($$result, { blocks: b.caption.content }, {}, {})}</figcaption>` : ``}
</figure>`;
});
...
const InvertedBlock = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$c);
  return `<div class="${"inverted-block svelte-g37r8"}">${(0, import_index_18e7c772.v)(Text, "Text").$$render($$result, { b }, {}, {})}
</div>`;
});
...
const Block_beam = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
...
const LogoBlock = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$a);
  return `<div class="${"logo-block svelte-1y9hgkm"}"><div class="${"top-row svelte-1y9hgkm"}"><div class="${"beam svelte-1y9hgkm"}">${(0, import_index_18e7c772.v)(Block_beam, "BlockBeam").$$render($$result, {}, {}, {})}</div>
    <div class="${"line svelte-1y9hgkm"}"></div></div>
  <div class="${"logoblock-text svelte-1y9hgkm"}">${(0, import_index_18e7c772.v)(Text, "Text").$$render($$result, { b }, {}, {})}</div>
</div>`;
});
...
const Embed = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$9);
  return `<div class="${"embed svelte-23luwt"}"><div class="${"inner svelte-23luwt"}">${b.url.includes("youtube") ? `<iframe width="${"720"}" height="${"480"}" src="${"https://www.youtube.com/embed/" + (0, import_index_18e7c772.e)((0, import_get_video_id.default)(b.url).id)}" frameborder="${"0"}" allow="${"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen class="${"svelte-23luwt"}"></iframe>` : ``}
    ${b.url.includes("vimeo") ? `<iframe width="${"720"}" height="${"480"}" src="${"https://player.vimeo.com/video/" + (0, import_index_18e7c772.e)((0, import_get_video_id.default)(b.url).id)}" frameborder="${"0"}" byline="${"false"}" color="${"#ffffff"}" allow="${"autoplay; fullscreen"}" allowfullscreen class="${"svelte-23luwt"}"></iframe>` : ``}</div></div>

${(0, import_has.default)(b, "caption.content") ? `<figcaption>${(0, import_index_18e7c772.v)(Blocks, "Blocks").$$render($$result, { blocks: b.caption.content }, {}, {})}</figcaption>` : ``}`;
});
...
const Divider = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const Columns = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$7);
  return `<div class="${"columns svelte-1yggcq"}">${b.title ? `<h2${(0, import_index_18e7c772.f)("id", (0, import_slugify.default)(b.title, { lower: true }), 0)} class="${"svelte-1yggcq"}">${(0, import_index_18e7c772.e)(b.title)}</h2>` : ``}
  ${(0, import_has.default)(b, "columnContent.content") ? `<div class="${"inner svelte-1yggcq"}">${(0, import_index_18e7c772.v)(Blocks, "Blocks").$$render($$result, { blocks: b.columnContent.content }, {}, {})}</div>` : ``}
</div>`;
});
...
const DonationWidget = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const ApplicationButton = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  ...
  <div class="${"application-button-large svelte-1dlavbd"}"><div class="${"column first svelte-1dlavbd"}">
      <div class="${"top svelte-1dlavbd"}"><div class="${"col first"}"><div class="${"circle svelte-1dlavbd"}"></div></div>
        <div class="${"col second svelte-1dlavbd"}"><div class="${"headline svelte-1dlavbd"}">APPLICATIONS ARE OPEN</div>
          ${b.applicationEndDate ? `<div class="${"date svelte-1dlavbd"}">Due by ${(0, import_index_18e7c772.e)(longFormatDate(b.applicationEndDate))}</div>` : ``}</div></div>

      
      ${(0, import_has.default)(b, "longText.content") ? `<div class="${"text svelte-1dlavbd"}">${(0, import_index_18e7c772.v)(Blocks, "Blocks").$$render($$result, { blocks: b.longText.content }, {}, {})}</div>` : ``}</div>

    <div class="${"column second svelte-1dlavbd"}">
      <a${(0, import_index_18e7c772.f)("href", b.url, 0)} target="${"_blank"}" class="${"apply-now svelte-1dlavbd"}">${(0, import_index_18e7c772.e)(b.shortText)}</a></div></div>` : `
  <div class="${"application-button-small svelte-1dlavbd"}"><div class="${"application-button-inner svelte-1dlavbd"}"><a${(0, import_index_18e7c772.f)("href", b.url, 0)} target="${"_blank"}" class="${"button svelte-1dlavbd"}">${b.applicationEndDate ? `<div class="${"circle svelte-1dlavbd"}"></div>` : ``}
        <div class="${"applications-text svelte-1dlavbd"}"><div class="${"short-text"}">${(0, import_index_18e7c772.e)(b.shortText)}</div>
          ${b.applicationEndDate ? `<div class="${"date svelte-1dlavbd"}">Applications Due by ${(0, import_index_18e7c772.e)(longFormatDate(b.applicationEndDate))}</div>` : ``}</div></a></div></div>`}`;
});
...
const Arrow_left = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
...
const Qa = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { item = {} } = $$props;
  if ($$props.item === void 0 && $$bindings.item && item !== void 0)
    $$bindings.item(item);
  $$result.css.add(css$3);
  return `<div class="${"qa svelte-nx2f1v"}"><div class="${"question svelte-nx2f1v"}"><div class="${"text svelte-nx2f1v"}">${(0, import_index_18e7c772.e)(item.question)}</div>
    <div class="${"icon svelte-nx2f1v"}">${`${(0, import_index_18e7c772.v)(Arrow_left, "ArrowLeft").$$render($$result, {}, {}, {})}`}</div></div>
  ${``}
</div>`;
});
...
const Faq = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$2);
  return `<div class="${"faq svelte-1lh5ive"}"><h2${(0, import_index_18e7c772.f)("id", (0, import_slugify.default)(b.title, { lower: true }), 0)} class="${"svelte-1lh5ive"}">${(0, import_index_18e7c772.e)(b.title)}</h2>
  <div class="${"faq-inner svelte-1lh5ive"}">${(0, import_index_18e7c772.b)(b.questionAnswer, (item) => {
    return `${(0, import_index_18e7c772.v)(Qa, "QA").$$render($$result, { item }, {}, {})}`;
  })}</div>
</div>`;
});
...
const Play_arrow = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
...
const Video = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  ...
  return `${function(__value) {
    ...
    return function(videoPost2) {
      return `
  <a${(0, import_index_18e7c772.f)("href", "/videos/" + (0, import_get.default)(videoPost2, "slug.current"), 0)} class="${"video-block svelte-139dsg8"}">
    ${videoPost2.mainImage ? `<img class="${"main-image svelte-139dsg8"}"${(0, import_index_18e7c772.f)("alt", videoPost2.title, 0)}${(0, import_index_18e7c772.f)("src", urlFor(videoPost2.mainImage).quality(90).saturation(-100).width(400).url(), 0)}>` : ``}
    <div class="${"icon svelte-139dsg8"}">${(0, import_index_18e7c772.v)(Play_arrow, "PlayArrow").$$render($$result, {}, {}, {})}</div>
    <div class="${"title svelte-139dsg8"}">${(0, import_index_18e7c772.e)(videoPost2.title)}</div></a>
`;
    }(__value);
  }(videoPost)}`;
});
const Blocks = (0, import_index_18e7c772.c)(($$result, $$props, $$bindings, slots) => {
  let { blocks = [] } = $$props;
  ...
  return `${(0, import_index_18e7c772.b)(blocks, (b) => {
    return `${b._type == "block" ? `${b.style == "logoBlock" ? `${(0, import_index_18e7c772.v)(LogoBlock, "LogoBlock").$$render($$result, { b }, {}, {})}` : `${b.style == "invertedBlock" ? `${(0, import_index_18e7c772.v)(InvertedBlock, "InvertedBlock").$$render($$result, { b }, {}, {})}` : `${(0, import_index_18e7c772.v)(Text, "Text").$$render($$result, { b }, {}, {})}`}`}` : ``}
  ${b._type == "image" ? `${mainSite ? `${(0, import_index_18e7c772.v)(ImageFromMainSite, "ImageFromMainSite").$$render($$result, { b }, {}, {})}` : `${(0, import_index_18e7c772.v)(Image, "Image").$$render($$result, { b }, {}, {})}`}` : ``}
  ${b._type == "embedBlock" ? `${(0, import_index_18e7c772.v)(Embed, "Embed").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "dividerBlock" ? `${(0, import_index_18e7c772.v)(Divider, "Divider").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "columnsBlock" ? `${(0, import_index_18e7c772.v)(Columns, "Columns").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "donationWidget" ? `${(0, import_index_18e7c772.v)(DonationWidget, "DonationWidget").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "applicationButton" ? `${(0, import_index_18e7c772.v)(ApplicationButton, "ApplicationButton").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "faq" ? `${(0, import_index_18e7c772.v)(Faq, "Faq").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "videoBlock" ? `${(0, import_index_18e7c772.v)(Video, "Video").$$render($$result, { b }, {}, {})}` : ``}`;
  })}`;
});
