...
function writable(value, start = import_index_c41c42e8.n) {
  let stop;
  const subscribers = /* @__PURE__ */ new Set();
  function set(new_value) {
    if ((0, import_index_c41c42e8.d)(value, new_value)) {
      value = new_value;
      if (stop) {
  ...
  function subscribe(run, invalidate = import_index_c41c42e8.n) {
    const subscriber = [run, invalidate];
    subscribers.add(subscriber);
    if (subscribers.size === 1) {
      stop = start(set) || import_index_c41c42e8.n;
    }
    run(value);
    return () => {
...
const focusPlayer = writable(true);
...
var personLink_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "a.svelte-zgjpki{color:#221f20;background:#dedcd5;text-decoration:none;margin-bottom:3px;display:inline-block}")();
const css$g = {
  code: "a.svelte-zgjpki{color:#221f20;background:#dedcd5;text-decoration:none;margin-bottom:3px;display:inline-block}",
  map: null
};
const Person_link = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${person ? `<a${(0, import_index_c41c42e8.f)("href", "/people/" + (0, import_get.default)(person, "slug.current"), 0)} class="${"svelte-zgjpki"}"><!-- HTML_TAG_START -->${overrideText ? renderNewLines(overrideText) : person.title}<!-- HTML_TAG_END --></a>` : ``}`;
});
var externalLink_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "svg.svelte-18gy7aj.svelte-18gy7aj{margin-left:4px}svg.svelte-18gy7aj path.svelte-18gy7aj{fill:#221f20}")();
const css$f = {
  code: "svg.svelte-18gy7aj.svelte-18gy7aj{margin-left:4px}svg.svelte-18gy7aj path.svelte-18gy7aj{fill:#221f20}",
  map: null
};
const External_link = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
...
const Text = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  const renderNewLines = (t) => t.replace(/(?:\r\n|\r|\n)/g, "<br>");
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  return `${b.children && b.children.length > 0 ? `${b.style == "h2" ? `<h2${(0, import_index_c41c42e8.f)("id", (0, import_slugify.default)(b.children[0].text, { lower: true }), 0)}>${(0, import_index_c41c42e8.b)(b.children, (c) => {
    return `${!c.marks || c.marks.length === 0 ? `${(0, import_index_c41c42e8.e)(c.text)}` : `<strong>${(0, import_index_c41c42e8.e)(c.text)}</strong>`}`;
  })}</h2>` : `${b.style == "h3" ? `<h3>${(0, import_index_c41c42e8.b)(b.children, (c) => {
    return `${(0, import_index_c41c42e8.e)(c.text)}`;
  })}</h3>` : `<p>${(0, import_index_c41c42e8.b)(b.children, (c) => {
    return `${!c.marks || c.marks.length === 0 ? `<!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END -->` : `${c.marks.includes("em") ? `<em><!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END --></em>` : `${c.marks.includes("strong") ? `<strong><!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END --></strong>` : `${b.markDefs.find((m) => m._key === c.marks[0])._type === "link" ? `<a${(0, import_index_c41c42e8.f)("href", b.markDefs.find((m) => m._key === c.marks[0]).href, 0)}><!-- HTML_TAG_START -->${renderNewLines(c.text)}<!-- HTML_TAG_END --> ${(0, import_index_c41c42e8.v)(External_link, "ExternalLink").$$render($$result, {}, {}, {})}</a>` : ``}
          ${b.markDefs.find((m) => m._key === c.marks[0])._type === "person" ? `${(0, import_index_c41c42e8.v)(Person_link, "PersonLink").$$render($$result, {
      overrideText: c.text,
      personId: b.markDefs.find((m) => m._key === c.marks[0]).link._ref
    }, {}, {})}` : ``}`}`}`}`;
  })}</p>`}`}` : ``}`;
});
var image_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "figure.svelte-17zfvzj.svelte-17zfvzj{margin-left:20px;margin-right:20px;float:left;border:1px solid #221f20;display:flex;float:left;max-width:50%}figure.right.svelte-17zfvzj.svelte-17zfvzj{float:right;max-width:50%}figure.full.svelte-17zfvzj.svelte-17zfvzj{float:unset;margin-left:0;margin-right:0;margin-top:0;border:unset;max-width:unset;width:100%}figure.full.svelte-17zfvzj img.svelte-17zfvzj{display:block;margin-left:auto;margin-right:auto}figure.full.svelte-17zfvzj figcaption.svelte-17zfvzj{padding:20px;border-top:1px solid #221f20;border-bottom:1px solid #221f20}figure.cover.svelte-17zfvzj.svelte-17zfvzj{float:unset}figure.cover.svelte-17zfvzj img.svelte-17zfvzj{width:100%;height:600px;object-fit:cover;object-position:center}@media(max-width: 800px){figure.cover.svelte-17zfvzj img.svelte-17zfvzj{height:300px}}figure.cover.svelte-17zfvzj figcaption.svelte-17zfvzj{padding:20px;border-top:1px solid #221f20;border-bottom:1px solid #221f20}@media(max-width: 800px){figure.cover.svelte-17zfvzj figcaption.svelte-17zfvzj{padding-left:0;padding-right:0}}.article figcaption p{margin-bottom:0;margin-left:0;margin-right:0}")();
const css$e = {
  code: "figure.svelte-17zfvzj.svelte-17zfvzj{margin-left:20px;margin-right:20px;float:left;border:1px solid #221f20;display:flex;float:left;max-width:50%}figure.right.svelte-17zfvzj.svelte-17zfvzj{float:right;max-width:50%}figure.full.svelte-17zfvzj.svelte-17zfvzj{float:unset;margin-left:0;margin-right:0;margin-top:0;border:unset;max-width:unset;width:100%}figure.full.svelte-17zfvzj img.svelte-17zfvzj{display:block;margin-left:auto;margin-right:auto}figure.full.svelte-17zfvzj figcaption.svelte-17zfvzj{padding:20px;border-top:1px solid #221f20;border-bottom:1px solid #221f20}figure.cover.svelte-17zfvzj.svelte-17zfvzj{float:unset}figure.cover.svelte-17zfvzj img.svelte-17zfvzj{width:100%;height:600px;object-fit:cover;object-position:center}@media(max-width: 800px){figure.cover.svelte-17zfvzj img.svelte-17zfvzj{height:300px}}figure.cover.svelte-17zfvzj figcaption.svelte-17zfvzj{padding:20px;border-top:1px solid #221f20;border-bottom:1px solid #221f20}@media(max-width: 800px){figure.cover.svelte-17zfvzj figcaption.svelte-17zfvzj{padding-left:0;padding-right:0}}.article figcaption p{margin-bottom:0;margin-left:0;margin-right:0}",
  map: null
};
const Image = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const ImageFromMainSite = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<figure class="${[
    "svelte-1bbn2f1",
    (b.layout == "left" ? "left" : "") + " " + (b.layout == "right" ? "right" : "") + " " + (b.fullWidth ? "full" : "") + " " + (b.coverAndCrop ? "cover" : "")
  ].join(" ").trim()}"><img${(0, import_index_c41c42e8.f)("src", urlForMainSite(b.asset).quality(90).width(1e3).url(), 0)}${(0, import_index_c41c42e8.f)("alt", b.alt ? b.alt : "", 0)} class="${"svelte-1bbn2f1"}">
  ${(0, import_has.default)(b, "caption.content") ? `<figcaption class="${"svelte-1bbn2f1"}">${(0, import_index_c41c42e8.v)(Blocks, "Blocks").$$render($$result, { blocks: b.caption.content }, {}, {})}</figcaption>` : ``}
</figure>`;
});
var invertedBlock_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".inverted-block.svelte-g37r8{width:100%;background:#221f20;padding:40px;color:#f5f4ee}")();
const css$c = {
  code: ".inverted-block.svelte-g37r8{width:100%;background:#221f20;padding:40px;color:#f5f4ee}",
  map: null
};
const InvertedBlock = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$c);
  return `<div class="${"inverted-block svelte-g37r8"}">${(0, import_index_c41c42e8.v)(Text, "Text").$$render($$result, { b }, {}, {})}
</div>`;
});
var blockBeam_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "svg.svelte-12vsv5 path.svelte-12vsv5{fill:none;stroke:#221f20;stroke-width:2.5px;stroke-miterlimit:10}")();
const css$b = {
  code: "svg.svelte-12vsv5 path.svelte-12vsv5{fill:none;stroke:#221f20;stroke-width:2.5px;stroke-miterlimit:10}",
  map: null
};
const Block_beam = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
...
var logoBlock_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".logo-block.svelte-1y9hgkm.svelte-1y9hgkm{margin-left:20px;margin-right:20px;margin-bottom:20px;width:calc(100% - 40px);border-bottom:1px solid #221f20;font-size:16px}.logo-block.svelte-1y9hgkm .top-row.svelte-1y9hgkm{display:flex}.logo-block.svelte-1y9hgkm .top-row .beam.svelte-1y9hgkm{width:160px;position:relative;top:0;left:1px;padding:0;line-height:0;display:inline-block}.logo-block.svelte-1y9hgkm .top-row .line.svelte-1y9hgkm{border-bottom:1px solid #221f20;width:100%}.logo-block.svelte-1y9hgkm .logoblock-text.svelte-1y9hgkm{padding-top:40px;padding-bottom:40px}.article .logoblock-text p{padding-left:0;padding-right:0;margin-top:0;margin-bottom:0}")();
const css$a = {
  code: ".logo-block.svelte-1y9hgkm.svelte-1y9hgkm{margin-left:20px;margin-right:20px;margin-bottom:20px;width:calc(100% - 40px);border-bottom:1px solid #221f20;font-size:16px}.logo-block.svelte-1y9hgkm .top-row.svelte-1y9hgkm{display:flex}.logo-block.svelte-1y9hgkm .top-row .beam.svelte-1y9hgkm{width:160px;position:relative;top:0;left:1px;padding:0;line-height:0;display:inline-block}.logo-block.svelte-1y9hgkm .top-row .line.svelte-1y9hgkm{border-bottom:1px solid #221f20;width:100%}.logo-block.svelte-1y9hgkm .logoblock-text.svelte-1y9hgkm{padding-top:40px;padding-bottom:40px}.article .logoblock-text p{padding-left:0;padding-right:0;margin-top:0;margin-bottom:0}",
  map: null
};
const LogoBlock = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$a);
  return `<div class="${"logo-block svelte-1y9hgkm"}"><div class="${"top-row svelte-1y9hgkm"}"><div class="${"beam svelte-1y9hgkm"}">${(0, import_index_c41c42e8.v)(Block_beam, "BlockBeam").$$render($$result, {}, {}, {})}</div>
    <div class="${"line svelte-1y9hgkm"}"></div></div>
  <div class="${"logoblock-text svelte-1y9hgkm"}">${(0, import_index_c41c42e8.v)(Text, "Text").$$render($$result, { b }, {}, {})}</div>
</div>`;
});
var embed_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".embed.svelte-23luwt.svelte-23luwt{color:#f5f4ee;margin-bottom:20px;cursor:pointer;display:flex;justify-content:center;align-items:center;padding-bottom:20px;padding-top:20px;width:100%}.embed.svelte-23luwt .inner.svelte-23luwt{width:720px}@media(max-width: 800px){.embed.svelte-23luwt .inner.svelte-23luwt{width:480px}}.embed.svelte-23luwt .inner iframe.svelte-23luwt{width:100%}.embed.full .inner.svelte-23luwt iframe.svelte-23luwt{height:100vh}")();
const css$9 = {
...
const Embed = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$9);
  return `<div class="${"embed svelte-23luwt"}"><div class="${"inner svelte-23luwt"}">${b.url.includes("youtube") ? `<iframe width="${"720"}" height="${"480"}" src="${"https://www.youtube.com/embed/" + (0, import_index_c41c42e8.e)((0, import_get_video_id.default)(b.url).id)}" frameborder="${"0"}" allow="${"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen class="${"svelte-23luwt"}"></iframe>` : ``}
    ${b.url.includes("vimeo") ? `<iframe width="${"720"}" height="${"480"}" src="${"https://player.vimeo.com/video/" + (0, import_index_c41c42e8.e)((0, import_get_video_id.default)(b.url).id)}" frameborder="${"0"}" byline="${"false"}" color="${"#ffffff"}" allow="${"autoplay; fullscreen"}" allowfullscreen class="${"svelte-23luwt"}"></iframe>` : ``}</div></div>
...
const Divider = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
var columns_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".columns.svelte-1yggcq h2.svelte-1yggcq{padding-top:20px;padding-bottom:20px}.columns.svelte-1yggcq .inner.svelte-1yggcq{width:100%;column-count:2;column-fill:balance;column-width:50%}")();
const css$7 = {
...
const Columns = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$7);
  return `<div class="${"columns svelte-1yggcq"}">${b.title ? `<h2${(0, import_index_c41c42e8.f)("id", (0, import_slugify.default)(b.title, { lower: true }), 0)} class="${"svelte-1yggcq"}">${(0, import_index_c41c42e8.e)(b.title)}</h2>` : ``}
  ${(0, import_has.default)(b, "columnContent.content") ? `<div class="${"inner svelte-1yggcq"}">${(0, import_index_c41c42e8.v)(Blocks, "Blocks").$$render($$result, { blocks: b.columnContent.content }, {}, {})}</div>` : ``}
</div>`;
});
var donationWidget_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".donation-widget.svelte-g1dluc{margin-top:20px;height:600px;background:red;width:100%}.gl-widget__frequency-selection-container{height:200px;background:yellow}.gl-widget__input-group{height:200px;background:green}.gl-widget__payment{height:200px;background:blue}.gl-widget__frequency-buttons{height:100% !important}")();
const css$6 = {
  code: ".donation-widget.svelte-g1dluc{margin-top:20px;height:600px;background:red;width:100%}.gl-widget__frequency-selection-container{height:200px;background:yellow}.gl-widget__input-group{height:200px;background:green}.gl-widget__payment{height:200px;background:blue}.gl-widget__frequency-buttons{height:100% !important}",
  map: null
};
const DonationWidget = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const ApplicationButton = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  ...
  <div class="${"application-button-large svelte-1dlavbd"}"><div class="${"column first svelte-1dlavbd"}">
      <div class="${"top svelte-1dlavbd"}"><div class="${"col first"}"><div class="${"circle svelte-1dlavbd"}"></div></div>
        <div class="${"col second svelte-1dlavbd"}"><div class="${"headline svelte-1dlavbd"}">APPLICATIONS ARE OPEN</div>
          ${b.applicationEndDate ? `<div class="${"date svelte-1dlavbd"}">Due by ${(0, import_index_c41c42e8.e)(longFormatDate(b.applicationEndDate))}</div>` : ``}</div></div>

      
      ${(0, import_has.default)(b, "longText.content") ? `<div class="${"text svelte-1dlavbd"}">${(0, import_index_c41c42e8.v)(Blocks, "Blocks").$$render($$result, { blocks: b.longText.content }, {}, {})}</div>` : ``}</div>

    <div class="${"column second svelte-1dlavbd"}">
      <a${(0, import_index_c41c42e8.f)("href", b.url, 0)} target="${"_blank"}" class="${"apply-now svelte-1dlavbd"}">${(0, import_index_c41c42e8.e)(b.shortText)}</a></div></div>` : `
  <div class="${"application-button-small svelte-1dlavbd"}"><div class="${"application-button-inner svelte-1dlavbd"}"><a${(0, import_index_c41c42e8.f)("href", b.url, 0)} target="${"_blank"}" class="${"button svelte-1dlavbd"}">${b.applicationEndDate ? `<div class="${"circle svelte-1dlavbd"}"></div>` : ``}
        <div class="${"applications-text svelte-1dlavbd"}"><div class="${"short-text"}">${(0, import_index_c41c42e8.e)(b.shortText)}</div>
          ${b.applicationEndDate ? `<div class="${"date svelte-1dlavbd"}">Applications Due by ${(0, import_index_c41c42e8.e)(longFormatDate(b.applicationEndDate))}</div>` : ``}</div></a></div></div>`}`;
});
var arrowDown_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "svg.svelte-hhwbji path.svelte-hhwbji{fill:#f5f4ee}")();
var arrowLeft_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "svg.svelte-bl0yym path.svelte-bl0yym{fill:#221f20}")();
const css$4 = {
  code: "svg.svelte-bl0yym path.svelte-bl0yym{fill:#221f20}",
  map: null
};
const Arrow_left = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
...
var qa_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".qa.svelte-nx2f1v.svelte-nx2f1v{width:100%;display:inline-block}.qa.svelte-nx2f1v .question.svelte-nx2f1v{width:100%;display:flex;justify-content:space-between;border-bottom:1px solid #221f20;cursor:pointer}.qa.svelte-nx2f1v .question .text.svelte-nx2f1v{font-style:italic;user-select:none;padding-top:10px;padding-bottom:10px;font-size:14px}.qa.svelte-nx2f1v .question .icon.svelte-nx2f1v{position:relative;top:6px}.qa.svelte-nx2f1v .answer.svelte-nx2f1v{border-bottom:1px solid #221f20}")();
const css$3 = {
  code: ".qa.svelte-nx2f1v.svelte-nx2f1v{width:100%;display:inline-block}.qa.svelte-nx2f1v .question.svelte-nx2f1v{width:100%;display:flex;justify-content:space-between;border-bottom:1px solid #221f20;cursor:pointer}.qa.svelte-nx2f1v .question .text.svelte-nx2f1v{font-style:italic;user-select:none;padding-top:10px;padding-bottom:10px;font-size:14px}.qa.svelte-nx2f1v .question .icon.svelte-nx2f1v{position:relative;top:6px}.qa.svelte-nx2f1v .answer.svelte-nx2f1v{border-bottom:1px solid #221f20}",
  map: null
};
const Qa = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { item = {} } = $$props;
  if ($$props.item === void 0 && $$bindings.item && item !== void 0)
    $$bindings.item(item);
  $$result.css.add(css$3);
  return `<div class="${"qa svelte-nx2f1v"}"><div class="${"question svelte-nx2f1v"}"><div class="${"text svelte-nx2f1v"}">${(0, import_index_c41c42e8.e)(item.question)}</div>
    <div class="${"icon svelte-nx2f1v"}">${`${(0, import_index_c41c42e8.v)(Arrow_left, "ArrowLeft").$$render($$result, {}, {}, {})}`}</div></div>
  ${``}
</div>`;
});
var faq_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".faq.svelte-1lh5ive.svelte-1lh5ive{display:inline-block;width:100%;padding:20px;margin-bottom:40px}.faq.svelte-1lh5ive h2.svelte-1lh5ive{margin-left:0;margin-right:0}@media(max-width: 800px){.faq.svelte-1lh5ive.svelte-1lh5ive{padding-left:0;padding-right:0}}.faq.svelte-1lh5ive .faq-inner.svelte-1lh5ive{margin-top:1em}")();
const css$2 = {
...
const Faq = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$2);
  return `<div class="${"faq svelte-1lh5ive"}"><h2${(0, import_index_c41c42e8.f)("id", (0, import_slugify.default)(b.title, { lower: true }), 0)} class="${"svelte-1lh5ive"}">${(0, import_index_c41c42e8.e)(b.title)}</h2>
  <div class="${"faq-inner svelte-1lh5ive"}">${(0, import_index_c41c42e8.b)(b.questionAnswer, (item) => {
    return `${(0, import_index_c41c42e8.v)(Qa, "QA").$$render($$result, { item }, {}, {})}`;
  })}</div>
</div>`;
});
var playArrow_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "svg.svelte-192w1ja.svelte-192w1ja{height:15px}svg.svelte-192w1ja path.svelte-192w1ja{fill:#221f20}")();
const css$1 = {
  code: "svg.svelte-192w1ja.svelte-192w1ja{height:15px}svg.svelte-192w1ja path.svelte-192w1ja{fill:#221f20}",
  map: null
};
const Play_arrow = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<svg width="${"21"}" height="${"35"}" viewBox="${"0 0 21 35"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}" class="${"svelte-192w1ja"}"><path d="${"M0.123047 34.0552V0L20.5614 17.0276L0.123047 34.0552Z"}" class="${"svelte-192w1ja"}"></path></svg>`;
});
var video_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".video-block.svelte-139dsg8.svelte-139dsg8{text-decoration:none;width:100%;position:relative;display:block;height:400px;margin-bottom:20px}.video-block.svelte-139dsg8 img.svelte-139dsg8{display:block;width:100%;height:100%;position:absolute;top:0;left:0}.video-block.svelte-139dsg8 .title.svelte-139dsg8{display:block;position:absolute;top:10px;left:80px;z-index:10;color:#f5f4ee;font-size:32px;line-height:1.2em}.video-block.svelte-139dsg8 .icon.svelte-139dsg8{position:absolute;top:10px;left:10px;z-index:100;width:70px;height:70px;border-radius:50%;background:#f5f4ee;color:#f5f4ee;line-height:1.2em;display:flex;justify-content:center;align-items:center}")();
const css = {
  code: ".video-block.svelte-139dsg8.svelte-139dsg8{text-decoration:none;width:100%;position:relative;display:block;height:400px;margin-bottom:20px}.video-block.svelte-139dsg8 img.svelte-139dsg8{display:block;width:100%;height:100%;position:absolute;top:0;left:0}.video-block.svelte-139dsg8 .title.svelte-139dsg8{display:block;position:absolute;top:10px;left:80px;z-index:10;color:#f5f4ee;font-size:32px;line-height:1.2em}.video-block.svelte-139dsg8 .icon.svelte-139dsg8{position:absolute;top:10px;left:10px;z-index:100;width:70px;height:70px;border-radius:50%;background:#f5f4ee;color:#f5f4ee;line-height:1.2em;display:flex;justify-content:center;align-items:center}",
  map: null
};
const Video = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  ...
  return `${function(__value) {
    ...
    return function(videoPost2) {
      return `
  <a${(0, import_index_c41c42e8.f)("href", "/videos/" + (0, import_get.default)(videoPost2, "slug.current"), 0)} class="${"video-block svelte-139dsg8"}">
    ${videoPost2.mainImage ? `<img class="${"main-image svelte-139dsg8"}"${(0, import_index_c41c42e8.f)("alt", videoPost2.title, 0)}${(0, import_index_c41c42e8.f)("src", urlFor(videoPost2.mainImage).quality(90).width(400).url(), 0)}>` : ``}
    <div class="${"icon svelte-139dsg8"}">${(0, import_index_c41c42e8.v)(Play_arrow, "PlayArrow").$$render($$result, {}, {}, {})}</div>
    <div class="${"title svelte-139dsg8"}">${(0, import_index_c41c42e8.e)(videoPost2.title)}</div></a>
`;
    }(__value);
  }(videoPost)}`;
});
const Blocks = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  ...
  ${b._type == "columnsBlock" ? `${(0, import_index_c41c42e8.v)(Columns, "Columns").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "donationWidget" ? `${(0, import_index_c41c42e8.v)(DonationWidget, "DonationWidget").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "applicationButton" ? `${(0, import_index_c41c42e8.v)(ApplicationButton, "ApplicationButton").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "faq" ? `${(0, import_index_c41c42e8.v)(Faq, "Faq").$$render($$result, { b }, {}, {})}` : ``}
  ${b._type == "videoBlock" ? `${(0, import_index_c41c42e8.v)(Video, "Video").$$render($$result, { b }, {}, {})}` : ``}`;
  })}`;
});
...
const centeringInlineStyles = writable("transform: translateX(-50%) translateY(-50%);");
const checkPortalOverlap = () => {
  if ((0, import_index_c41c42e8.g)(currentRoom).portals && Array.isArray((0, import_index_c41c42e8.g)(currentRoom).portals)) {
    let overlapIndex = false;
    (0, import_index_c41c42e8.g)(currentRoom).portals.forEach((p) => {
      if ((0, import_index_c41c42e8.g)(players)[(0, import_index_c41c42e8.g)(localPlayer).uuid].x === p.x && (0, import_index_c41c42e8.g)(players)[(0, import_index_c41c42e8.g)(localPlayer).uuid].y === p.y) {
...
const checkZoneOverlap = () => {
  let overlapIndex = false;
  (0, import_index_c41c42e8.g)(currentRoom).zones.forEach((z) => {
    if ((0, import_inRange.default)((0, import_index_c41c42e8.g)(players)[(0, import_index_c41c42e8.g)(localPlayer).uuid].x, z.x, z.x + z.dimensions.width) && (0, import_inRange.default)((0, import_index_c41c42e8.g)(players)[(0, import_index_c41c42e8.g)(localPlayer).uuid].y, z.y, z.y + z.dimensions.height)) {
      overlapIndex = z;
    }
  });
  if (overlapIndex) {
