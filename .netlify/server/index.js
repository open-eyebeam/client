...
const Root = (0, import_index_c41c42e8.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_c41c42e8.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_c41c42e8.v)(components[0] || import_index_c41c42e8.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_c41c42e8.v)(components[1] || import_index_c41c42e8.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${(0, import_index_c41c42e8.v)(components[2] || import_index_c41c42e8.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`;
        }
      })}` : `${(0, import_index_c41c42e8.v)(components[1] || import_index_c41c42e8.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_c41c42e8.v)(components[0] || import_index_c41c42e8.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
const template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n\n<head>\n	<meta charset="utf-8" />\n	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />\n	<meta name="theme-color" content="#000000" />\n\n	<title>Open Eyebeam</title>\n\n	<link rel="icon" type="image/png" href="' + assets2 + `/images/favicon.png" />
	<link rel="preconnect" href="https://fonts.gstatic.com">
	<link href="https://fonts.googleapis.com/css2?family=Literata:ital,wght@0,300;0,400;1,300;1,400&amp;display=swap"
		rel="stylesheet">

	<meta property="og:title" content="Open Eyebeam">
	<meta property="twitter:title" content="Open Eyebeam">
	<meta property="description" content="Open Eyebeam is an experimental digital art studio and event space for Eyebeam's artist fellows and community.">
	<meta property="og:description" content="Open Eyebeam is an experimental digital art studio and event space for Eyebeam's artist fellows and community.">
	<meta property="twitter:description" content="Open Eyebeam is an experimental digital art studio and event space for Eyebeam's artist fellows and community.">
	<meta property="image" content="/images/open_eyebeam.png">
	<meta property="og:image" content="/images/open_eyebeam.png">
	<meta property="twitter:image" content="/images/open_eyebeam.png">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:url" content="https://open.eyebeam.org">
	<meta property="og:url" content="https://open.eyebeam.org">
	<meta property=" og:type" content="website">
	<meta property="og:site_name" content="Open Eyebeam">
	...
	<style>
		...
		* {
			...
			-webkit-tap-highlight-color: rgba(197, 197, 197, 0.3);
		}
		...
		*::selection {
		...
		.tippy-box[data-theme~='static'] .tippy-content {
			padding: 0px 1px;
		}

		.tippy-box[data-theme~='name'] .tippy-content {
			padding: 0px 1px;
		}
	</style>
